...
ggplot() + 
  ...
  geom_sf() + 
  labs(caption = "Map 1(Bad Map) - EZones and LStops in Chicago")+ 
...
This Map used a black-white base map that includes details of the city’s administrative boundaries, and lightly fill color with transparency to show its relationship with the Enterprise Zones. Then a more contrasted color is used to represent the L Stops. The resulting map fails to show the relationship between the Enterprise Zone and the L Stops as the polygon element is not so clearly standing out from the rest of the map. The fill color needs to be adjusted to a stronger type and with a darker outline.  
...
ggplot()+  
  ...
  geom_sf() +  
  labs(caption = "Map 2 - EZones and LStops in Chicago")+  
...
ggplot() +  
  annotation_map_tile(zoomin = 0, progress = "none", type = "stamenbw") +  
  geom_sf() +  
  labs(caption = "Map 3 - EZones and LStops in Chicago") +  
...
ggplot() +  
  ...
  labs(caption = "Map 4 - EZones and LStops in Chicago") +  
...
ggplot() + 
  annotation_map_tile(zoomin = 0, progress = "none", type = "cartolight")  + 
  geom_sf() + 
  labs(caption = "Map 5 (Best Map) - EZones and LStops in Chicago")+ 
